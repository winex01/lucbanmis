  ...
  <div class="panel panel-default">
    <div class="panel-body">
      ...
      <ol class="breadcrumb">
        ...
        <form class="form-horizontal" method="POST" action="<?= base_url('insertUser') ?>">
          <?php csrf(); ?>
          <?php currentURI(); ?>
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="alert alert-info col-lg-3 col-lg-offset-2">
                  <strong>Note:</strong> Default password is: "password"
              </div>
